...
const SOCIAL_LINKS: SocialLink[] = [
  ...
  },
  {
    ...
    color: '#7A1220',
    svgPath: 'M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 010 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z',
  },
  {
    name: 'Stack Overflow',
          ...
          {SOCIAL_LINKS.map((social) => (
            <a
              ...
              onMouseEnter={(e) => {
                ...
                el.style.boxShadow = '0 12px 28px rgba(30,25,18,0.1)';
                el.style.borderColor = social.color;
                el.style.background = 'rgba(251,247,236,0.98)';
                // Scale down siblings
                const parent = el.parentElement;
                if (parent) {
                  Array.from(parent.children).forEach((child) => {
                    if (child !== el) {
                      (child as HTMLElement).style.transform = 'scale(0.93)';
              ...
              onMouseLeave={(e) => {
                ...
                el.style.background = 'var(--paper-panel)';
                // Restore siblings
                const parent = el.parentElement;
                if (parent) {
                  Array.from(parent.children).forEach((child) => {
            ...
            >
              ...
              <span style={{ color: 'var(--ink)' }}>{social.name}</span>
            </a>
          ))}
        </div>
      </div>
